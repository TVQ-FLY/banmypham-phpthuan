        ...
        <div class="container">
            <div class="thankiu__box text-center">
                <div class="thankiu_image">
                    <img src="style/images/icon/icon-success.gif" alt="success">
                </div>
                <h1 class="thankiu__heading h2">Đặt hàng thành công</h1>
                <span class="thankiu__heading2 h3">Cảm ơn quý khách đã mua hàng tại MyShop</span>
...
?>
    <section class="thankiu">
        <div class="container">
            <div class="thankiu__box text-center">
                <div class="thankiu_image">
                    <img src="style/images/icon/icon-error.gif" alt="success">
                </div>
                ...
                <p class="thankiu__description">Quý khách vui lòng thực hiện thanh toán lại đơn hàng, các sản phẩm hiện vẫn còn ở trong giỏ hàng</p>
                <div class="thankiu_link">
                    <a href="index.php" class="btn btn__outline">Trang chủ</a>
