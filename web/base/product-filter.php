                            ...
                            ?>
                                <a class="tag__item" href="index.php?page=products<?php echo $url_category;
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="btn__tag d-flex align-center"><img class="icon-close" src="./style/images/icon/icon-close.png" alt=""></div>
                            ...
                            <div class="product__card d-flex flex-column">
                                <div class="product__image p-relative">
                                    <a href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
                                        <img class="w-100 h-100 object-fit-cover" src="quantri/modules/product/uploads/<?php echo $row['product_image'] ?>" alt="product image" />
                                    </a>
                                    <?php
                            ...
                            ?>
                                <ul class="pagination__items d-flex align-center justify-center">
                                    ...
                                    ?>
                                        <li class="pagination__item">
                                            <a class="d-flex align-center" href="<?php echo $currentLink ?>&pagenumber=<?php echo $page - 1 ?>">
                                                <img src="./style/images/icon/arrow-left.svg" alt="">
                                            </a>
                                        </li>
                                    <?php
                                    } ?>
                                    ...
                                    ?>
                                        <li class="pagination__item">
                                            <a class="d-flex align-center" href="<?php echo $currentLink ?>&pagenumber=<?php echo $page + 1 ?>">
                                                <img src="./style/images/icon/icon-nextlink.svg" alt="">
                                            </a>
                                        </li>
                                    <?php
                                    } ?>
...
<script>
    ...
    function setUrlPrice() {
        ...
        // Cập nhật tham số pricefrom và priceto của URL mới
        url.searchParams.set('pricefrom', inputMin);
        url.searchParams.set('priceto', inputMax);
        
        // Lấy URL mới đã cập nhật tham số và gán cho href của button filter
        btnFilter.href = url.toString();
    }
</script>
