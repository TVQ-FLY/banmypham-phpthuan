        ...
        <div class="row">
                        ...
                        ?>
                            <div class="checkout__item d-flex align-center">
                                <div class="checkout__image p-relative">
                                    ...
                                    <a href="index.php?page=product_detail&product_id=<?php echo $cart_item['product_id'] ?>"><img class="w-100 d-block object-fit-cover ratio-1" src="quantri/modules/product/uploads/<?php echo $cart_item['product_image'] ?>" alt=""></a>
                                </div>
            ...
            <div class="w-100 d-flex align-center space-between">
                <div class="order__detail--action">
                    ...
                    ?>
                        <a href="web/handle/order.php?order_cancel=1&order_code=<?php echo $order_code ?>" class="btn btn__solid" onClick="return confirm('Bạn có muốn hủy đơn hàng này không?')">Hủy đơn hàng</a>
                    <?php
                    } elseif ($order['order_status'] == 3) {
                    ?>
                        <a href="web/handle/order.php?order_confirm=1&order_code=<?php echo $order_code ?>" class="btn btn__solid" onClick="return confirm('Xác nhận đã nhận được hàng?')">Xác nhận đã nhận hàng</a>
                    <?php
                    } else {
                    ?>
                        <a href="index.php?page=contact" class="btn btn__solid">Liên hệ</a>
                    <?php
                    }
                    ?>
