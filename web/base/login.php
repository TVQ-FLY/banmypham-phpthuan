<section class="login pd-section">
    <div class="form-box">
        <div class="form-value">
            <form action="web/handle/login.php" autocomplete="on" method="POST">
                ...
                <div class="forget">
                    <label for=""><input type="checkbox">Nhớ tài khoản   &emsp; &emsp; &emsp;&emsp; &emsp; &nbsp  <a href="#">Quên mật khẩu</a></label>
