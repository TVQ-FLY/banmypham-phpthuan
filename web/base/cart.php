            ...
            <div class="cart__container">
                ...
                <div class="cart__content">
                    ...
                    ?>
                            <div class="cart__item d-grid">
                                <div class="cart__image">
                                    <a href="index.php?page=product_detail&product_id=<?php echo $cart_item['product_id'] ?>"><img class="w-100" src="quantri/modules/product/uploads/<?php echo $cart_item['product_image'] ?>" alt="product" /></a>
                                </div>
                                ...
                                <div class="cart__quantity"> 
                                    <div class="cart__quantity--container d-flex align-center">
                                        <div class="select__number p-relative">
                                            <a href="web/handle/addtocart.php?div=<?php echo $cart_item['product_id'] ?>" class="select__number--minus cursor-pointer p-absolute d-flex align-center justify-center">
                                                <img src="./style/images/icon/minus.svg" alt="" />
                                            </a>
                                            <input type="text" value="<?php echo $cart_item['product_quantity'] ?>" class="select__number--value heading-6 w-100 h-100" />
                                            <a href="web/handle/addtocart.php?sum=<?php echo $cart_item['product_id'] ?>" class="select__number--plus cursor-pointer p-absolute d-flex align-center justify-center">
                                                <img src="./style/images/icon/plus.svg" alt="" />
                                            </a>
                                        </div>
                                        <div class="cart__delete cursor-pointer d-flex align-center justify-center">
                                            <a href="web/handle/addtocart.php?delete=<?php echo $cart_item['product_id'] ?>">
                                                <img src="./style/images/icon/delete.svg" alt="delete" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
