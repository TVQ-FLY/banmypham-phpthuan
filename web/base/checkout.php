...
<section class="checkout pd-section">
    <div class="container">
        <form action="web/handle/checkout.php" method="POST">
            <div class="row">
                    ...
                    <div class="checkout__cart">
                        <div class="checkout__items">
                            ...
                            ?>
                                ...
                                ?>
                                <span>Không tồn tại trong giỏ hàng</span>
                            <?php
                            }
                            ?>
                ...
                <div class="col" style="--w-md: 7">
                    ...
                    <div class="payment__items">
                        <div class="payment__item checked d-flex align-center">
                            ...
                            <img class="payment__icon" src="./style/images/icon/icon-shipcod.png" alt="Ship COD">
