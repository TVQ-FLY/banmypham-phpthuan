                ...
                <div class="row">
                        ...
                        <div class="product-detail__media">
                            <div class="media__items d-flex">
                                <div class="media__item product-image-container w-100">
                                    <img class="w-100" src="quantri/modules/product/uploads/<?php echo $row_product_detail['product_image'] ?>" alt="image product" />
                        ...
                        <div class="product-detail__slide-control d-flex justify-center md-none">
                            <div class="slide-control__slide p-relative">
                                <button class="slide-control__slide--prev cursor-pointer p-absolute">
                                    <img src="./style/images/icon/chevron-left.svg" alt="sub" />
                                </button>
                                ...
                                <button class="slide-control__slide--next cursor-pointer p-absolute">
                                    <img src="./style/images/icon/chevron-right.svg" alt="sum" />
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="col" style="--w-md: 6">
                        <div class="product-detail__info">
                            <form method="POST" action="web/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="select__number p-relative">
                                            <button type="button" class="select__number--minus cursor-pointer p-absolute" onclick="decreaseQuantity()">
                                                <img src="./style/images/icon/minus.svg" alt="sub" />
                                            </button>
                                            ...
                                            <button type="button" class="select__number--plus cursor-pointer p-absolute" onclick="increaseQuantity()">
                                                <img src="./style/images/icon/plus.svg" alt="sum" />
                                            </button>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="tab-pane">
                    ...
                    <div class="comment-form">
                        <form class="post-comment" method="POST" action="web/handle/evaluate_rating.php?product_id=<?php echo $product_id; ?>">
