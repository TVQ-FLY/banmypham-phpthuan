                    ...
                    <div class="sort__item h5">
                        <details class="sort__select p-relative">
                            <summary class="cursor-pointer d-flex align-center">
                                Giá
                                <img src="./style/images/icon/icon-chevron-down.svg" alt="down" class="icon-open d-block" style="margin-left: 8px;">
                                <img src="./style/images/icon/chevron-up.svg" alt="up" class="icon-close d-none" style="margin-left: 8px;">
                            </summary>
