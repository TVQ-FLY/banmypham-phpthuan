...
<section class="contact pd-top">
    <div class="container"> 
        <div class="contact__container">
            <h1 class="contact__heading h2">Liên hệ MyShop</h1>
            <div class="contact__infomation">
                <p>Gmail: lethithaothanh2001@gmail.com</p>
                <p>SDT: 0364383436</p>
            </div>
            <h3 class="contact__title h5">Thời gian làm việc</h3>
            <div class="contact__infomation">
                <p>Thứ 2 – Thứ 6: 09:00am – 09:30pm</p>
