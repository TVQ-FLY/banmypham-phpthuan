                ...
                <div class="row">
                    <div class="col">
                        <div class="article__img--item">
                            <img class="w-100 d-block object-fit-cover" src="quantri/modules/blog/uploads/<?php echo $row['article_image'] ?>" alt="image article">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="article__content d-flex justify-center">
                        <div class="article__container pd-section">
                            ...
                            <div class="article__footer text-center d-flex align-center justify-center">
                                <img src="./style/images/icon/arrow-left.svg" alt="back" style="margin-right: 8px;">
            ...
            <div class="article__box">
                <div class="blog__comment">
                    ...
                    <div class="comment__form">
                        ...
                        <form action="web/handle/comment.php?article_id=<?php echo $article_id ?>" method="POST">
