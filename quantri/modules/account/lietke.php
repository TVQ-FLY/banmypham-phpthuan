                ...
                <div class="main-pane-top d-flex justify-center align-center">
                    <div class="input__search p-relative">
                        <form class="search-form" action="" method="POST">
                            ...
                            <input type="search" class="form-control" name="account_keyword" placeholder="Tìm Kiếm" title="Search here">
                        </form>
                    </div>
                </div>
...
<script>
    ...
    function getCheckedCheckboxes() {
        ...
        btnDelete.href = "modules/account/xuly.php?delete=1&data=" + JSON.stringify(checkedIds);
    }
</script>
