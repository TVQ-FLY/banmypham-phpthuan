                    ...
                    <div class="main-pane-top d-flex space-between align-center">
                        ...
                        <div class="input__search p-relative">
                            <form class="search-form" action="" method="POST">
                                ...
                                <input type="search" name="order_search" class="form-control" placeholder=" Tìm kiếm " title="Search here">
                            </form>
                        </div>
...
<script>
    ...
    function getCheckedCheckboxes() {
        ...
        btnDelete.href = "modules/order/xuly.php?delete=1&data="+ JSON.stringify(checkedIds);
    }
</script>