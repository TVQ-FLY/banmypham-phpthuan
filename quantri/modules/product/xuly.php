...
if (isset($_POST['product_add'])) {
    $sql_add = "INSERT INTO product(product_name, product_category, product_brand, product_price_import, product_price, product_sale, product_description, product_image, product_status) VALUE('" . $product_name . "', '" . $product_category . "', '" . $product_brand . "', '" . $product_price_import . "', '" . $product_price . "', '" . $product_sale . "', '" . $product_description . "', '" . $product_image . "', '" . $product_status . "')";
